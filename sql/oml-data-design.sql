...
INSERT INTO gameInformation VALUES (UNHEX('aed673e1153044199b6cf38f920dacf0'), (SELECT profileId FROM profile
                                    WHERE profileId = UNHEX('1ed673e1153044199b6cf38f920dacf0')),'Minecraft',
                                    NULL, 'Live');
...
SELECT profileDisplayName,gameTitle FROM profile INNER JOIN gameInformation ON profile.profileId = gameInformation.gameHost;
